...
export function TestResendMailConnectionStatusForm() {
  const testConnection = api.settings.testMailConfiguration.useMutation({
    onSuccess: (data) => {
            ...
            <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
              <div className="space-y-0.5">
                <FormLabel className="text-base">
                  Resend Mail Connection
                </FormLabel>
                <div className="flex items-center gap-2">
                  <FormDescription>
                    Test the connection to your mail provider.
                  </FormDescription>
                  <Dialog>
                    {testConnection.data && (
